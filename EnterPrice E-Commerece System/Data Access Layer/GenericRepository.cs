...
namespace EnterPrice_E_Commerece_System.CRUD
{
    public class GenericRepository<T> : IGenericRepository<T> where T : class
    {
        ...
        public IEnumerable<T> GetAll(Func<T, bool> predicate) => context.Set<T>().Where(predicate);


        public void Update(T entity) => context.Update(entity);

        public async Task AddRangeAsync(IEnumerable<T> data) => await context.Set<T>().AddRangeAsync(data);
