...
{
    /// <inheritdoc />
    public partial class SalesOrders_Migration : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProudctVariantID = table.Column<int>(type: "int", nullable: false),
                    Qunatity = table.Column<int>(type: "int", nullable: false),
                    ProductVariantID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CartItem", x => new { x.ProudctVariantID, x.CartID });
                    table.ForeignKey(
